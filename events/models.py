...
# Signifique qu'on veut plus de flexibilité sur le statut puisqu'on a aucune info dessus dans l'énoncé d'où le modèle Status
...
class Event(models.Model):
    ...
    support_contact = models.ForeignKey(to=CustomUser, on_delete=models.DO_NOTHING, related_name="events_handled_by_this_support_contact")
